...
import (
	...
	pb "code.cloudfoundry.org/go-loggregator/v9/rpc/loggregator_v2"
)

type FakeLoggregatorIngressServer struct {
	ReceivedEnvelopes chan *pb.Envelope
	Addr              string
...
func NewFakeLoggregatorIngressServer(serverCert, serverKey, caCert string) (*FakeLoggregatorIngressServer, error) {
	...
	return &FakeLoggregatorIngressServer{
		tlsConfig:         tlsConfig,
		ReceivedEnvelopes: make(chan *pb.Envelope, 1000),
		Addr:              "localhost:0",
	}, nil
}

func (t *FakeLoggregatorIngressServer) Sender(srv pb.Ingress_SenderServer) error {
	return grpc.Errorf(codes.Unimplemented, "this function is not implemented")
}

func (t *FakeLoggregatorIngressServer) BatchSender(srv pb.Ingress_BatchSenderServer) error {
	for {
...
func (t *FakeLoggregatorIngressServer) Send(_ context.Context, b *pb.EnvelopeBatch) (*pb.SendResponse, error) {
...
func (t *FakeLoggregatorIngressServer) Start() error {
	...
	pb.RegisterIngressServer(t.grpcServer, t)
